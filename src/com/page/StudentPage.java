...
public class StudentPage extends JFrame {
    ...
    private JMenuItem viewStudentInfoItem, changePasswordItem, exitItem, selectCourseItem, viewAllCoursesItem; // 菜单项
    ...
    public StudentPage(User user) {
        ...
        // 学生管理菜单项
        viewStudentInfoItem = new JMenuItem("学生信息查询");
        ...
        // 课程管理菜单项
        selectCourseItem = new JMenuItem("学生选课");
        viewAllCoursesItem = new JMenuItem("学生课程成绩查询");

        // 为菜单项添加事件监听器
        selectCourseItem.addActionListener(e -> {
            new CourseSelectionPage(); // 打开选课页面
        });
